...
class SalesforceBulkAPI(object):
    ...
    def __init__(self, username=None, password=None, security_token=None, organization_id=None, sandbox=False, API_version="46.0", batch_size=10000, logger=None, verbose=True):
